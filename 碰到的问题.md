...
public Docket docket() {
    ...
    Docket docket = new Docket(DocumentationType.SWAGGER_2)
        ...
        .apiInfo(apiInfo)
        .select()
        .apis(RequestHandlerSelectors.basePackage("com.sky.controller"))	//扫包路径
...
注：GenericJackson2JsonRedisSerializer()可以换为GenericJackson2JsonRedisSerializer()
...
- nested exception is io.lettuce.core.RedisException: java.io.IOException: 远程主机强迫关闭了一个现有的连接。
	...
	- 解决方法：
		...
		- 心跳机制：（上面两方法方法比较慢需要20s，所有还需要设置超时时间不能太短，yml里面）
