...
![image-20230624164519220](task1Img/image-20230624164519220.png)



### 2.项目收获

![image-20230616163440573](task1Img/image-20230616163440573.png)
...
![68294185617](task1Img/1682941856172.png)
...
![image-20201025150602129](task1Img/1682941888453.png)

+ 选择css预处理

![image-20220629175133593](task1Img/1682941900018.png)

+ 选择eslint的风格 （eslint 代码规范的检验工具，检验代码是否符合规范）
+ 比如：const age = 18;   =>  报错！多加了分号！后面有工具，一保存，全部格式化成最规范的样子

![68294191856](task1Img/1682941918562.png)

+ 选择校验的时机 （直接回车）

![68294193579](task1Img/1682941935794.png)

+ 选择配置文件的生成方式 （直接回车）

![68294194798](task1Img/1682941947985.png)

- 是否保存预设，下次直接使用？  =>   不保存，输入 N

![68294196155](task1Img/1682941961551.png)

+ 等待安装，项目初始化完成

![68294197476](task1Img/1682941974763.png)
...
![image-20230616184644176](task1Img/image-20230616184644176.png)
...
![image-20230616184726099](task1Img/image-20230616184726099.png)

比如日历组件、键盘组件、打分组件、下拉筛选组件等

组件库并不是唯一的，常用的组件库还有以下几种：

pc:  [element-ui](https://element.eleme.cn/#/zh-CN)    [element-plus](https://element-plus.gitee.io/zh-CN/)    [iview](https://iview.github.io/)      **[ant-design-vue](https://antdv.com/components/overview-cn)**
...
![68294468866](task1Img/1682944688666.png)
...
![68294483040](task1Img/1682944830403.png)
...
如果是加载文件夹下的index.vue，可以省略 “/index.vue” 
...
![image-20230617152947594](task1Img/image-20230617152947594.png)
...
![image-20230617155648436](task1Img/image-20230617155648436.png)

### (2) 登录静态布局

![image-20230617160232955](task1Img/image-20230617160232955.png)
...
![image-20230617161654856](task1Img/image-20230617161654856.png)
...
![image-20230617163721858](task1Img/image-20230617163721858.png)
...
![image-20230619121937770](task1Img/image-20230619121937770.png)
...
![image-20230619122706439](task1Img/image-20230619122706439.png)
...
![image-20230617165906943](task1Img/image-20230617165906943.png)
...
当返回的 promise 对象是 reject 的时，会抛出异常，await 的代码就不会往下走了，使用 await 只能接收到正确的 promise 对象
...
![image-20230623173049799](task1Img/image-20230623173049799.png)
...
![image-20230623173117931](task1Img/image-20230623173117931.png)
...
![image-20230620220932154](task1Img/image-20230620220932154.png)
...
<template>
  <div class="home">
    ...
    <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white">
      <van-swipe-item>
        <img src="@/task1Img/banner1.jpg" alt="">
      </van-swipe-item>
      <van-swipe-item>
        <img src="@/task1Img/banner2.jpg" alt="">
      </van-swipe-item>
      <van-swipe-item>
        <img src="@/task1Img/banner3.jpg" alt="">
      </van-swipe-item>
    </van-swipe>
...
<template>
  <div class="goods-item" @click="$router.push('/prodetail')">
    <div class="left">
      <img src="@/task1Img/product.jpg" alt="" />
    </div>
    <div class="right">
...
![image-20230621144449700](task1Img/image-20230621144449700.png)
...
![image-20230624222814532](task1Img/image-20230624222814532.png)
...
<img src="task1Img/image-20230621155728973.png" alt="image-20230621155728973" style="zoom:80%;" />
...
<img src="task1Img/image-20230624231331980.png" alt="image-20230624231331980" style="zoom:67%;" />
...
<img src="task1Img/image-20230624233945821.png" alt="image-20230624233945821" style="zoom: 67%;" />
...
```jsx
import defaultImg from '@/task1Img/default-avatar.png'
...
![image-20230621193957697](task1Img/image-20230621193957697.png)
...
![image-20230621195126291](task1Img/image-20230621195126291.png)
...
![image-20230624150118755](task1Img/image-20230624150118755.png)
...
3. 添加 token 鉴权判断，跳转携带回跳地址
   ...
   注：用push会影响返回的页面，用户体验不好；用replace会替换当前页面，用户返回时不会又返回登录页面
...
![image-20230624154814818](task1Img/image-20230624154814818.png)
...
![image-20230624154339504](task1Img/image-20230624154339504.png)
...
![image-20230624160427732](task1Img/image-20230624160427732.png)
...
![image-20230624161704931](task1Img/image-20230624161704931.png)
...
<div class="empty-cart" v-else>
  <img src="@/task1Img/empty.png" alt="">
  <div class="tips">
    您的购物车是空的, 快去逛逛吧
  </div>
...
![image-20230702155433790](task1Img/image-20230702155433790.png)
...
.address {
  ...
  color: #666;
  position: relative;
  background: url(@/task1Img/border-line.png) bottom repeat-x;
...
vue提供的语法，通过此语法，可以把一些数据和函数直接混入组件内部，从而实现跨组件复用。其编写的格式和组件的script标签里的 export default {} 部分一样，所以使用引入js的数据或函数的方法和使用组件内定义的一样。

若导入的js有同名的函数，在 mixins 数组中后面的会覆盖前面的；若组件内有同名数据或函数，组件内优先级更高。
...
<template>
  <div class="user">
    <div class="head-page" v-if="isLogin">
      <div class="head-img">
        <img src="@/task1Img/default-avatar.png" alt="" />
      </div>
      <div class="info">
...
actions: {
  logout (context) {
    ...
    // {root: true} 表示开启全局模式，此时从context就会从默认的局部context变成全局的了
...
路由懒加载 & 异步组件（按需异步加载）， 不会一上来就将所有的组件都加载，而是访问到对应的路由了，才加载解析这个路由对应的所有组件
