笔记来源：[SpringSecurity (shrink.fun)](https://shrink.fun/note/spring-security/#/)
...
![](noteimg/image-20220110112541559.png)
...
![](noteimg/image-20220110104531129.png)
...
![](noteimg/image-20220110103518334.png)

#### [Authentication](#)

认证以及认证成功的信息主要是由 Authentication 的实现类进行保存的，其接口定义为：

![](noteimg/image-20220110104815645.png)
...
![](noteimg/image-20220110110946267.png)

#### [AccessDecisionVoter](#)

> AccessDecisionVoter (访问决定投票器)，投票器会检查用户是否具备应有的角色，进而投出赞成、反对或者弃权票。

![](noteimg/image-20220110111011018.png)
...
![](noteimg/image-20220110111037603.png)
...
[https://docs.spring.io/spring-security/site/docs/5.5.4/reference/html5/#servlet-architecture](https://docs.spring.io/spring-security/site/docs/5.5.4/reference/html5/ target=)
...
![](noteimg/image-20220112095052138.png)
...
![](noteimg/image-20220112095638356.png)

### [执行流程（即SecurityFilter的使用情况和调用顺序）](#)

在 SpringSecurity 中 `认证、授权` 等功能都是基于[过滤器](https://docs.spring.io/spring-security/site/docs/5.5.4/reference/html5/ target=)完成的。
...
![](noteimg/image-20220111211538604.png)

![](noteimg/image-20220111211436764.png)
...
>
> ![](noteimg/SpringSecurity下CSRF原理.png)**注意:** HEAD、OPTIONS、TRACE 等方法就没有必要使用 CSRF 令牌了，强行使用可能会导致令牌泄露！
...
#### [单线程模式：MODE\_THREADLOCAL（一次请求过程中数据只能在本线程中获取）](#)
...
#### [父子线程模式：MODE\_INHERITABLETHREADLOCAL（一次请求过程中数据可以在本线程和后代线程中获取）](#)
